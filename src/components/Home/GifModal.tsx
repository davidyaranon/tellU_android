      ...
      <IonContent>
        <div style={{ width: "100%" }}>
          ...
          <IonToolbar className='ion-no-border'>
            <IonSearchbar className="ion-no-border" color={context.darkMode ? "" : "light"} enterkeyhint="search" onKeyDown={e => isEnterPressedGif(e.key)} animated ref={gifSearchRef}></IonSearchbar>
          </IonToolbar>
        </div>
