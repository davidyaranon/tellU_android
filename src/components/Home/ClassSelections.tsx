  ...
  if (schoolName) {
    return (
      <IonFab horizontal="start" style={{ textAlign: "center", alignItems: "center", alignSelf: "center", display: "flex", paddingTop: "" }}>
        ...
        <IonItem className="class-name-selection" mode="md" color={context.darkMode ? "light-item" : ""}>
          <IonSelect aria-label="" interface="action-sheet" interfaceOptions={selectOptions} okText="Select" cancelText="Cancel" mode="md" value={postClassName} placeholder="Class: "
            onIonChange={(e: any) => {
              setPostClassNumber("");
        ...
        {postClassName && postClassName.length > 0 &&
          <>
            ...
            <IonItem className='class-number-selection' color={context.darkMode ? "light-item" : ""}>
              <IonSelect interface="action-sheet" interfaceOptions={selectOptionsNumber} okText="Select" cancelText="Cancel" mode="md" value={postClassNumber} placeholder="#:"
                onIonChange={(e: any) => {
